        ...
        <div className='flex items-center justify-between p-4'>
            ...
            <div className='flex items-center gap-6 justify-end w-full'>
                ...
                <div className='bg-white rounded-full w-8 h-8 flex items-center justify-center cursor-pointer relative'>
                    ...
                    <div className='rounded-full absolute -top-3 -right-3 w-5 h-5 flex items-center justify-center bg-purple-500 text-white text-xs'>1</div>
                </div>
                ...
                <Image src='/images/avatar.png' alt='pb-placeholder' width={36} height={36} className='rounded-full' />
            </div>
        </div>
    );
}
